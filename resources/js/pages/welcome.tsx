                ...
                <div className="mx-auto max-w-screen-xl px-4 py-8 lg:py-16">
                    ...
                    <div className="grid grid-cols-2 items-center justify-center gap-6 sm:grid-cols-3 sm:gap-8 md:grid-cols-4 md:gap-10 lg:grid-cols-6">
                        <a
                            ...
                            className="flex flex-col items-center justify-center space-y-2 transition-colors hover:text-red-500"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex flex-col items-center justify-center space-y-2 transition-colors hover:text-sky-500"
                        >
                            <svg height="40" viewBox="-11.9 -2 1003.9 995.6" width="40" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="m12.1 353.9s-24-17.3 4.8-40.4l67.1-60s19.2-20.2 39.5-2.6l619.2 468.8v224.8s-.3 35.3-45.6 31.4z"
                                    fill="currentColor"
                                />
                                <path d="m171.7 498.8-159.6 145.1s-16.4 12.2 0 34l74.1 67.4s17.6 18.9 43.6-2.6l169.2-128.3z" fill="currentColor" />
                                <path d="m451.9 500 292.7-223.5-1.9-223.6s-12.5-48.8-54.2-23.4l-389.5 354.5z" fill="currentColor" />
                                <path
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex flex-col items-center justify-center space-y-2 transition-colors hover:text-gray-400 dark:hover:text-neutral-500"
                        >
                            <svg height="40" viewBox="0 -3.1 2490.3 2493" width="40" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >
                            <svg width="40" height="40" viewBox="0 0 256 258" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex flex-col items-center justify-center space-y-2 transition-colors hover:text-cyan-600 dark:hover:text-cyan-400"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex flex-col items-center justify-center space-y-2 transition-colors hover:text-green-500"
                        >
