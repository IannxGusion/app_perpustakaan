        ...
        >
            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-4">
                <div className="w-full max-w-md space-y-3 rounded-2xl bg-white p-8 shadow-lg dark:bg-black">
                    ...
                    <p className="mb-5 text-center text-sm">Masukkan email Anda untuk menerima link untuk reset password</p>
                    ...
                    <form onSubmit={submit} className="flex flex-col gap-4">
                        <div>
                            ...
                            <div className="focus-within:border-primary-500 focus-within:ring-primary-500 flex items-center rounded-lg border border-gray-300 shadow-sm focus-within:ring-1">
                                <Input
                                    id="email"
                                    type="email"
                                    name="email"
                        ...
                        <Button className="active:bg-primary-800 w-full dark:text-white" disabled={processing}>
                    ...
                    <div className="text-muted-foreground mt-4 space-x-1 text-center text-sm">
                        ...
                        <TextLink href={route('login')} className="text-primary-500">
                            log in
                        </TextLink>
                    </div>
                </div>
